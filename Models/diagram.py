...
class Diagram:
    ...
    # or attribute.
            ...
            #     #Class
            #     if tokens[1].lower() == "class":
            #         classadd.UMLClass.delete_class(self, tokens[2])
            #     #Attribute
            #     elif tokens[1].lower() == "attribute":
            #         #TODO when attribute is done
            #         print("TODO")
            #     #Relationship
            #     elif tokens[1].lower() == "relationship":
            #         relationship.UMLRelationship.delete_relationship(self, tokens[2], tokens[3])
            #     else:
            ...
            #     if tokens[1].lower() == "class":
            #         classadd.UMLClass.list_class()
            #     elif tokens[1].lower() == "classes":
            #         #TODO list all aspects of a class
            #         print("TODO")
            #     elif tokens[1].lower() == "relationship" or tokens[1].lower() == "relationships":
            #         relationship.UMLRelationship.list_relationships() 
            #     else:
            #         print("Command not recognized\n")
